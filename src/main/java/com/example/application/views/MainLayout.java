...
import com.example.application.views.helloworld2.SortableView;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Hello World2", SortableView.class, LineAwesomeIcon.GLOBE_SOLID.create()));
