...
@Route(value = "eager", layout = MainLayout.class)
//@RouteAlias(value = "", layout = MainLayout1.class)
public class EagerLoadingView extends VerticalLayout {

    private static final int COLUMNS = 100;

    public EagerLoadingView() {
